                    ...
                    <div className="col-sm-4 col-md-6">
                        ...
                        <div className="btn-group">
                            <ul className="list-inline">
                                <li><a target="_blank" href="https://twitter.com/minhaj_cse">Twitter</a></li>
                                <li><a target="_blank" href="https://www.facebook.com/minhajul.islamsohel">Facebook</a></li>
                                <li><a target="_blank" href="https://github.com/minhajCSE">Github</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
